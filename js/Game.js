(function(){
    ...
    var Game = window.Game = function(){
        ...
        this.ctx2.fillText( "丁文娟出品" + "必属精品" , this.myCanvas.width/2 , this.myCanvas.height*0.95);
        this.ctx2.fillText("    游戏名：" +  "纸飞机下降" + "" + "" , this.myCanvas.width/2.5, this.myCanvas.height*0.1);
        this.ctx2.fillText("作  者" +  "："  + "丁文娟" , this.myCanvas.width/2.5, this.myCanvas.height*0.17);
